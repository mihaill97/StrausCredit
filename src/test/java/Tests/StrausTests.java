...
public class StrausTests extends ChromeSettings {
    @Test
    public void LoginStrausCredit ()throws InterruptedException{
    ...
    @Test
    public void RegistrationStrausCredit () throws InterruptedException{
        MainPage mainPage = new MainPage(driver);
        LoginPage loginPage = new LoginPage(driver);
